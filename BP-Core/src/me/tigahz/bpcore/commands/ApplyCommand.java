...
public class ApplyCommand implements CommandHandler {
	...
	public boolean onCommand(CommandSender cs, Command cmd, String l, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase(CommandType.getCommand(CommandType.APPLY))) {
			...
			if (!(cs instanceof Player)) {
				...
				p.sendMessage(Ref.format(messages("prefix") + messages("application-link")));
	...
	public String getName() {
		return CommandType.getCommand(CommandType.APPLY);
	}

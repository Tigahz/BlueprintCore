...
public class WebsiteCommand implements CommandHandler {
	...
	public boolean onCommand(CommandSender cs, Command cmd, String l, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase(CommandType.getCommand(CommandType.WEBSITE))) {
			...
			if (!(cs instanceof Player)) {
				...
				p.sendMessage(Ref.format(messages("prefix") + messages("website-link")));
	...
	public String getName() {
		return CommandType.getCommand(CommandType.WEBSITE);
	}

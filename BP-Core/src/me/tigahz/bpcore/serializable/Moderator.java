...
public final class Moderator implements ConfigurationSerializable {
	...
	public Moderator(Map<String, Object> map) {
	...
	public ItemStack asItemStack() {
		...
		if (username == null) {
			...
			meta.setDisplayName(Ref.format("&c&lPlayer hasn't joined"));
		} else {
			meta.setOwner(username);
			meta.setDisplayName(Ref.format("&c&l" + username));
		}
		
		List<String> ll = new ArrayList<>();
		for (String list : lore) {
			ll.add(Ref.format("&c&o" + list));
		}
		meta.setLore(ll);
